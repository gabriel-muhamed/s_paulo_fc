        ...
        <div className="match_top">
          <div className="left">
            <div
              className="icon"
              style={{
                background: `url(${require(`../../Resources/images/team_icons/${match.localThmb}.png`)})`,
              }}
            ></div>
        ...
        <div className="match_bottom">
          <div className="left">
            <div
              className="icon"
              style={{
                background: `url(${require(`../../Resources/images/team_icons/${match.awayThmb}.png`)})`,
              }}
            ></div>
